...
from schemas import EmailPayload , EmailConsent


app = FastAPI()

ENV_DOMAIN_NAME = "pixieoflife.co.za"
ENV_MAILGUN_API_KEY = "NO"
ENV_MAILGUN_FRIENDLY_NAME = "Panic SA"
ENV_MAILGUN_FRIENDLY_EMAIL_PREFIX = "mailgun"
